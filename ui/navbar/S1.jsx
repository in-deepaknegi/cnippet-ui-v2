    ...
    return (
        <header className="relative isolate overflow-hidden bg-white py-6">
            <div className="mx-auto flex max-w-full items-center justify-between px-6 md:max-w-[95%] lg:px-8">
                ...
                <nav className="hidden uppercase lg:flex lg:gap-x-12">
                    {links.map((link, i) => (
                        <Link
                            key={i}
                            href={link.url}
                            className="text-sm font-medium leading-6 text-gray-700 hover:text-gray-950"
                        >
                            {link.title}
                        </Link>
                    ))}
                ...
                <div className="hidden lg:flex lg:items-center">
                    ...
                    <Link
                        href="#"
                        className="-my-2.5 ml-8 inline-flex justify-center rounded-full bg-slate-950 px-4 py-1.5 text-base font-medium uppercase text-white hover:bg-slate-800"
                    >
                        <span>
