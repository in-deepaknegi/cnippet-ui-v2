            ...
            <nav className="relative z-20 border-gray-100 bg-white py-6">
                ...
                {mobileMenu && (
                    <div className="h-full lg:hidden" role="dialog" aria-modal="true">
                        <div className="absolute right-0 top-0 isolate z-50 mt-4 h-full w-full overflow-hidden border-t bg-white bg-opacity-80 bg-clip-padding px-6 py-3 backdrop-blur-lg backdrop-filter sm:max-w-sm">
