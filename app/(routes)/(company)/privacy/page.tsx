        ...
        <>
            ...
            <main>
                <div className="max-w-3xl mx-auto mt-20">
                    ...
                    <p className="mb-4">
                        Thank you for visiting <strong>Cnippet</strong> website. This Privacy Policy outlines how we collect, use, and safeguard your personal information. Please read the following information carefully:
                    </p>
                    ...
                    <p className="mb-4">
                        <strong>Cnippet</strong> reserves the right to update or modify this Privacy Policy at any time. Changes will be effective immediately upon posting to our website. We encourage you to review this page periodically for the latest information on our privacy practices.
                    </p>

                    <h3 className="text-xl font-semibold mb-2">Contact Us:</h3>
                    <p className="mb-4">
                        If you have any questions or concerns about our Privacy Policy, please contact us at [<a href="mailto:ui@cnippet.com" className='text-blue-700'>ui@cnippet.com</a> ].
                    </p>
