        ...
        <>
            ...
            <main>
                <div className="max-w-3xl mx-auto mt-20">
                    ...
                    <p className="mb-4">
                        Thank you for choosing <strong>Cnippet</strong>. We appreciate your business and look forward to providing you with our [product/service]. Please review our cancellation policy below:
                    </p>
                    ...
                    <p className="mb-4">
                        <strong>Cnippet</strong> reserves the right to modify or update this cancellation policy at any time. Please check our website for the latest version.
                    </p>

                    <p>
                        By making a booking with <strong>Cnippet</strong>, you agree to comply with and be bound by the terms and conditions of this cancellation policy.
                    </p>
                </div>
            </main>
            <Footer />
