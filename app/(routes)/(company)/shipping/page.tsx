        ...
        <>
            ...
            <main>
                <div className="max-w-3xl mx-auto mt-20">
                    ...
                    <p className="mb-4">
                        Welcome to <strong>Cnippet</strong> Shipping Policy. Please read the following information carefully before making a purchase from our website:
                    </p>
                    ...
                    <p className="mb-4">
                        <strong>Cnippet</strong> is not responsible for any lost or damaged items during transit. If you encounter any issues with your shipment, please contact the shipping carrier to file a claim.
                    </p>

                    <h3 className="text-xl font-semibold mb-2">Contact Us:</h3>
                    <p className="mb-4">
                        If you have any questions or concerns about our Shipping Policy, please contact us at [<a href="mailto:ui@cnippet.com" className='text-blue-700'>ui@cnippet.com</a> ].
                    </p>

                    <h3 className="text-xl font-semibold mb-2">Policy Updates:</h3>
                    <p className="mb-4">
                        <strong>Cnippet</strong> reserves the right to update or modify this Shipping Policy at any time. Changes will be effective immediately upon posting to our website. Please check this page periodically for the latest information.
                    </p>

                    <p>
                        By making a purchase from <strong>Cnippet</strong>, you agree to comply with and be bound by the terms and conditions of this Shipping Policy.
                    </p>
                </div>
            </main>
            <Footer />
